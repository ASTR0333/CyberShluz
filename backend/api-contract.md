...
## 7. Добавление личного SSH-ключа на L-MS
**POST** `/api/v1/stand/{stand_id}/pubkey`

Публичный ключ устанавливается пользователю `student` только на L-MS. Только
L-MS получает Floating IP и доступна студенту по SSH.
