...
ask VM_BOOTSTRAP_USER "Legacy Linux images initial SSH user (empty disables password bootstrap)" "$(read_existing VM_BOOTSTRAP_USER "$(read_existing VM_DEFAULT_USER '')")"
ask_secret VM_BOOTSTRAP_PASSWORD "Legacy Linux images initial SSH password (empty disables password bootstrap)" "$(read_existing VM_BOOTSTRAP_PASSWORD "$(read_existing VM_DEFAULT_PASSWORD '')")"
ask_secret VM_BOOTSTRAP_ROOT_PASSWORD "Legacy image root password for su (empty = SSH password)" "$(read_existing VM_BOOTSTRAP_ROOT_PASSWORD '')"
...
umask 077
{
    ...
    printf 'VM_BOOTSTRAP_ROOT_PASSWORD=%s\n' "${VM_BOOTSTRAP_ROOT_PASSWORD}"
